...
export default {
	...
	"config": {
		...
		"site": {
			...
			"pages": {
				...
				"data": [
					...
					{
						"title": "Dev Note 1",
						"path": "notebooks/dev-notes/note-1/",
						"notebook": "dev-notes"
					}
				]
			}
		...
		"note": {
			...
			"date": "2025-01-12",
			"updated": "2025-01-14",
			"cover": "https://blog.example.com/images/css-grid.jpg",
			"excerpt": "<p>Learn CSS Grid layout techniques</p>",
			"description": "CSS Grid basics",
			"content": "<p>CSS Grid content here</p>",
			"tags": [
				"css",
				"layout"
			],
