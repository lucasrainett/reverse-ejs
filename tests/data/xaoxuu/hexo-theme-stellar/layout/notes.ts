	...
	"config": {
		...
		"theme": {
			"article": {
				...
				"license": "CC BY-NC-SA 4.0 by [{author.name}]({author.url})",
				"share": [
					"wechat",
					"weibo",
					"email",
			...
			"wiki": {
				"tree": {
					"my-wiki": {
						...
						"description": "A sample wiki project documentation.",
						"homepage": {
							"path": "wiki/my-wiki/"
						},
						"pages": [
							{
								...
								"path": "wiki/my-wiki/getting-started/"
							},
							{
								"title": "Configuration",
								"path": "wiki/my-wiki/configuration/"
							}
						],
						"leftbar": [
							"toc"
					...
					"dev-notes": {
						...
						"tagTree": {
							...
							"javascript": {
								...
								"name": "JavaScript",
								"part": "JavaScript",
								"path": "notebooks/dev-notes/tags/javascript/",
								"children": []
							},
							"css": {
								"id": "css",
								"name": "CSS",
								"part": "CSS",
								"path": "notebooks/dev-notes/tags/css/",
								"children": []
							}
						}
					}
			...
			"comments": {
				...
				"waline": {
					...
					"meta_css": "/css/comments/waline.css",
				...
				"twikoo": {
					"js": "https://cdn.jsdelivr.net/npm/twikoo@1.6.0/dist/twikoo.all.min.js",
					"envId": "https://twikoo.example.com"
				},
				"artalk": {
					"js": "https://cdn.jsdelivr.net/npm/artalk@2/dist/Artalk.js",
					"css": "https://cdn.jsdelivr.net/npm/artalk@2/dist/Artalk.css",
			...
			"footer": {
				"content": "<p>Powered by Hexo & Stellar</p>",
			...
			"plugins": {
				...
				"tianli_gpt": {
					"field": "post",
					"js": "https://cdn.example.com/tianli-gpt.js",
					"key": "gpt-key-123"
				}
			},
			"search": {
			...
			"data_services": {
				"contributors": {
					"edit_this_page": {
						"repo": "https://github.com/alicechen/blog"
					}
				},
				"video": {
					"js": "/js/lib/video-check.js"
				}
			},
			"widgets": {
				"toc": {
			...
			"posts": [
				{
					...
					"date": "2025-01-12",
					"updated": "2025-01-14",
					"path": "notebooks/dev-notes/css-grid/",
					"link": "",
					"cover": "",
					"excerpt": "<p>Learn CSS Grid</p>",
					"description": "CSS Grid basics",
					"content": "<p>CSS Grid content</p>",
					"tags": [
						"css"
					],
					"pin": false,
				...
				},
				{
					...
					"date": "2025-01-08",
					"updated": "2025-01-10",
					"path": "notebooks/dev-notes/js-closures/",
					"link": "",
					"cover": "",
					"excerpt": "<p>Understanding closures</p>",
					"description": "Closures in JS",
					"content": "<p>Closures content</p>",
					"tags": [
						"javascript"
					],
					"pin": true,
		...
		"site": {
			"posts": [
				...
				},
				{
					...
					"excerpt": "<p>Learn Node.js basics</p>",
					"tags": [
						{
							"name": "nodejs"
						}
