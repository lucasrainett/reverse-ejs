...
export default {
	...
	"config": {
		...
		"theme": {
			...
			"nickname": "Alice Chen",
			"description": "Full-stack developer exploring the boundaries of web technology.",
			"links": {
			...
			"post_copyright_license_text": "CC BY-NC-SA 4.0",
			"post_copyright_slogan_enable": true,
			"post_copyright_slogan_text": "Do what you love, love what you do.",
		...
		"post": {
			...
			"_id": "clk7abc123",
			"path": "about-me/",
			"permalink": "https://blog.example.com/about-me/",
			"date": {},
			"updated": {},
			"content": "<p>This tutorial walks through creating a RESTful API using Express.js and MongoDB.</p>",
			"excerpt": "<p>Learn how to build a modern REST API.</p>",
