	...
	"config": {
		...
		"theme": {
			...
			"profile": {
				...
				"introduction": "Passionate about open source and clean code."
			},
			"myProjects": {
				"enable": true,
				"data": {
			...
			"mySkills": {
				...
				"data": {
					...
					"CSS": {
						"background": "linear-gradient(to right, #1AD6FD, #1D62F0)",
						"percent": "85%"
					},
					"Node.js": {
						"background": "linear-gradient(to right, #4cbf30, #0f9d58)",
						"percent": "80%"
					}
				}
			},
			"myGallery": {
				"enable": true,
				"data": {
					"Sunset View": "/medias/gallery/sunset.jpg",
					"Mountain Peak": "/medias/gallery/mountain.jpg",
					"City Night": "/medias/gallery/city-night.jpg"
				}
			},
			"featureImages": [
