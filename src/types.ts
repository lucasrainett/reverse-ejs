...
export type Token =
  ...
  | { type: 'loop_start'; arrayName: string; itemName: string; loopVar?: string }
  | { type: 'loop_end' }
...
export type Pattern =
  ...
  | { type: 'literal';     value: string }
  | { type: 'variable';    name: string }
  | { type: 'loop';        arrayName: string; itemName: string; body: Pattern; loopVar?: string }
  | { type: 'conditional'; thenBranch: Pattern; elseBranch?: Pattern; condition?: string; condId?: number }
